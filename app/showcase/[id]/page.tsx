...
export default async function PreviewSinglePage({
  ...
  return (
    <main className="relative grid min-h-screen gap-20 p-6">
      <div className="bg-indigo absolute top-0 right-0 left-0 z-0 h-[357px] w-full rounded-b-4xl"></div>

      <div className="relative z-10 mx-auto mt-28 w-full max-w-[349px] rounded-xl bg-white px-14 py-12 shadow">
      ...
      <p className="text-grey-dark self-end text-center text-sm">
        Create your own link in bio page with{" "}
        <Link href="/" className="text-indigo font-bold underline">
          devlinks-uwu
        </Link>
      </p>
    </main>
